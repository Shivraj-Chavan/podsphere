  ...
  >
      ...
      >
        ...
        <div
          ...
          style={{ background: "linear-gradient(to right, #f472b6, #fb7185, #f43f5e)" }}
        />
        ...
        <div className="pt-7 pb-5 px-7 text-center">
          ...
          {/* <h2 className="text-lg font-extrabold text-gray-900 tracking-tight">Welcome Back</h2> */}
        ...
        <form onSubmit={handleSubmit} className="px-7 pb-7 space-y-3">
          ...
          <div>
            <label
              className="block text-[10px] font-bold tracking-widest mb-1.5"
              style={{ color: "#9ca3af" }}
            >
              EMAIL ADDRESS
            </label>
